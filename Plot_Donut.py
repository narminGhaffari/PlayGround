...
def PlotDonut (subsetValues, savePath, color = ['#a50026', '#fdae61'], figTitle = 'Donut Figure'):
    ...
    """
        Plots donut figure. The inpu to the function can be single list or the list of lists to plot and save the figures automatically. 
        Arguments:
            subsetValues: is a list containing the values for the donut figure.
            
            example 1: subsetValues = [10, 20]            
